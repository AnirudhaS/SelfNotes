...
namespace SelfNotes
{
    public class Dal : IDisposable
    {
        ...
        private string connectionString = "mongodb://localhost:27017/"; //System.Environment.GetEnvironmentVariable("localhost");
        MongoUrl url;

        private string dbName = "SelfNotes";
